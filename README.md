...
[![CI](https://github.com/john-livingston/freq/actions/workflows/ci.yml/badge.svg)](https://github.com/john-livingston/freq/actions/workflows/ci.yml)
[![Python](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-brightgreen.svg)](https://www.gnu.org/licenses/gpl-3.0)
[![Documentation](https://img.shields.io/badge/docs-009688.svg)](https://john-livingston.github.io/freq/)
...
- `q(Δt)` when `--l1_Prot > 0` (else 1): `--l1_qp cos` (default)
  `[1 + cos(2πΔt/Prot)]/2`, a cosine bell carrying the fundamental only, or
...
`--l1_cv` ranks a grid of noise models by the Hara et al. (2020) procedure. For
each model, peaks with log₁₀ FAP < `--l1_cv_fap_threshold` (−0.5) are kept and the
model is scored by the median held-out log-likelihood over `--l1_cv_nsim` (400)
random 60/40 train/test splits. The full ℓ₁ periodogram is then rerun with the
best-scoring model:
...
Figures are regenerated with `python scripts/gen_docs_figures.py`. Pushes to
`master` deploy the site automatically; `mkdocs gh-deploy` publishes by hand.

## License / citations

GPL-3 (the vendored l1periodogram is GPL-3; the vendored gls.py is MIT).
